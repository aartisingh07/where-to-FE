...
const categoryStyle = {
  ...
  'Mountain Peak': { emoji: '🗻', color: 'from-purple-500/20 to-pink-500/10', badge: 'bg-purple-500/20 text-purple-300' },
  'Scenic Viewpoint': { emoji: '🌅', color: 'from-purple-500/20 to-pink-500/10', badge: 'bg-purple-500/20 text-purple-300' },
